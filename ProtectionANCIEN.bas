...
Private Const IdProduit As Long = 2
Private Const Produit As String = "OndeV"
Private Const Guid As String = "{7E84410F-0BD7-458D-AAB8-4879F6CF09D7}"
Private Const Vermaj As Long = 1
Private Const Vermin As Long = 0
Private Const message As String = "its-ondev"

'Définition des paramètres des noms de fichiers utilisés avec Qlm
Private Const NomFichierLicence As String = "relic.ctu"
Private Const NomFichierSerial As String = "reser.ctu"
...
Public Const E_LBSERIAL = "Serial : "
Public Const F_LBSERIAL = "N° Série : "
...
On Error GoTo FIN_ERR
    ...
    'présent dans le fichier ascii. La licence permet de maintenir à jour la fenêtre "A propose de"
...
Public Function VerifLicence(txt1 As String, txt2 As String, strlic As String, strserial As String) As Boolean
        ...
        ElseIf (IsTrue(nStatus, IsLicense.ELicenseStatus.EKeyDemo)) Then
            ...
            Else
                ...
                'on écrit le numero de série dans le fichier ascii
        ...
        ElseIf (IsTrue(nStatus, IsLicense.ELicenseStatus.EKeyPermanent) And strlic <> "") Then 'la condition strlic permet de maintenir la fen^tre A propos de à jour
            ...
            ' the key is OK
            'si ok écriture du serial dans le fichier ascii dans le répertoire d'installation de l'application
...
Private Function LireTxt(nomfic As String) As String
